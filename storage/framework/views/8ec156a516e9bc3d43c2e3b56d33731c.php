...
<section id="homepage" class="bg-gradient-to-tr from-purple-700 to-indigo-800 text-white py-16 px-4">
    <div class="max-w-7xl mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
            <a href="<?php echo e(route('public.packages.index')); ?>" class="bg-white text-purple-700 hover:bg-purple-50 px-6 py-3 rounded-lg font-bold text-base transition shadow-md">Lihat Paket Internet</a>
            <a href="<?php echo e(route('public.coverage.check')); ?>" class="bg-transparent border border-white hover:bg-white hover:text-purple-700 px-6 py-3 rounded-lg font-bold text-base transition">Cek Wilayah Anda</a>
        </div>
    </div>
</section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white border rounded-2xl shadow-sm hover:shadow-lg transition p-6 flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
                ...
                <p class="text-gray-500 text-sm mb-4">Up to <span class="font-bold text-purple-600"><?php echo e($package->speed_mbps); ?> Mbps</span></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 items-center">
            ...
            <div class="space-y-5 sm:space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <a
                        href="<?php echo e(route('public.orders.create')); ?>"
                    ...
                    <a
                        href="<?php echo e(route('public.coverage.check')); ?>"
...
<?php echo $__env->make('layouts.myrepublic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelforfun\resources\views/public/home.blade.php ENDPATH**/ ?>