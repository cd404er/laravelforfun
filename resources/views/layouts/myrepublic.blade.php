    ...
    <header class="bg-white shadow-sm border-b sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8 text-sm font-medium">
                <a href="{{ route('public.home') }}" class="text-gray-600 hover:text-purple-600 transition">Home</a>
                <a href="{{ route('public.home') }}#tentang" class="text-gray-600 hover:text-purple-600 transition">Tentang</a>

                <a href="{{ route('public.packages.index') }}" class="text-gray-600 hover:text-purple-600 transition">Paket Internet</a>
                <a href="{{ route('public.coverage.check') }}" class="text-gray-600 hover:text-purple-600 transition">Cek Area</a>
                <a href="#kontak-kami" class="text-gray-600 hover:text-purple-600 transition">Kontak Kami</a>
            </nav>
            <a href="{{ route('public.orders.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition shadow-md shadow-purple-200">
    ...
    <footer id="kontak-kami" class="bg-slate-900 text-slate-300">
        ...
        <div class="bg-purple-700 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
                ...
                <div class="flex flex-wrap gap-3 justify-center md:justify-end shrink-0">
                    <a href="{{ route('public.orders.create') }}"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li>
                        <a href="{{ route('public.home') }}" class="footer-link flex items-center gap-2 text-slate-400">
                            <i class="fa-solid fa-chevron-right text-purple-500 text-xs"></i> Beranda
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('public.packages.index') }}" class="footer-link flex items-center gap-2 text-slate-400">
                            <i class="fa-solid fa-chevron-right text-purple-500 text-xs"></i> Paket Internet
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('public.coverage.check') }}" class="footer-link flex items-center gap-2 text-slate-400">
                            <i class="fa-solid fa-chevron-right text-purple-500 text-xs"></i> Cek Jangkauan Area
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('public.orders.create') }}" class="footer-link flex items-center gap-2 text-slate-400">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li>
                        <a href="{{ route('public.packages.show', 'value-50-mbps') }}" class="footer-link flex items-center gap-2 text-slate-400">
                            <i class="fa-solid fa-wifi text-purple-500 text-xs"></i> Value 50 Mbps — Rp 309.000/bln
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('public.packages.show', 'fast-100-mbps') }}" class="footer-link flex items-center gap-2 text-slate-400">
                            <i class="fa-solid fa-wifi text-purple-500 text-xs"></i> Fast 100 Mbps — Rp 389.000/bln
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('public.packages.show', 'nova-150-mbps') }}" class="footer-link flex items-center gap-2 text-slate-400">
                            <i class="fa-solid fa-wifi text-purple-500 text-xs"></i> Nova 150 Mbps — Rp 469.000/bln
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('public.packages.show', 'gamer-250-mbps') }}" class="footer-link flex items-center gap-2 text-slate-400">
        ...
        <div class="border-t border-slate-800 py-4">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-slate-500">
                <p>&copy; {{ date('Y') }} <span class="text-slate-300 font-semibold">MyRepublic Sales Agent</span>. Semua Hak Cipta Dilindungi.</p>
